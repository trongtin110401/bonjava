...
public class GetCacheResultTaiXiuMd5Processor implements BaseProcessor<HttpServletRequest, String> {
    ...
    public String execute(Param<HttpServletRequest> param) {
        ...
        try {
            ...
            hashMap.put("min_hu_tx_auto_md5",cacheService.getValueStr("min_hu_tx_auto_md5"));
            hashMap.put("max_hu_tx_auto_md5",cacheService.getValueStr("max_hu_tx_auto_md5"));
            hashMap.put("hu_tx_auto_md5",cacheService.getValueStr("hu_tx_auto_md5"));
