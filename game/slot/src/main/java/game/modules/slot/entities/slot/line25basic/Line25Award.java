...
public enum Line25Award {
    ...
    PENTA_JACKPOT("PENTA_JACK_POT", 11, (byte) 10, Line25Item.JACKPOT, (byte) 5, 0f),
    ...
    Line25Award(String name, int index, byte id, Line25Item item, byte duplicate, float ratio) {
        this.id = id;
        this.item = item;
