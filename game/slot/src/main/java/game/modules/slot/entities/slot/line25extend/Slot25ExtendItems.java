...
//            };
    ...
    private static int[][] config = new int[][]
            {
                    {300, 50, 0, 35, 10, 10, 12, 25, 75, 80, 85},
                    {300, 50, 50, 25, 10, 15, 20, 25, 50, 60, 65},
                    {300, 50, 30, 35, 10, 15, 20, 25, 50, 60, 65},
                    {300, 50, 25, 30, 20, 20, 20, 25, 50, 55, 60},
                    {300, 50, 0, 35, 10, 15, 20, 30, 65, 75, 85}
            };
