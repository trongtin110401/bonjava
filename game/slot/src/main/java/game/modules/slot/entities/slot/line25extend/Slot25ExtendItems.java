...
public class Slot25ExtendItems {
    ...
    private static int[][] config = new int[][]
            {
                    {15, 10, 0, 35, 10, 10, 12, 25, 75, 80, 85},
                    {15, 10, 20, 25, 10, 15, 20, 25, 50, 60, 65},
                    {15, 10, 20, 35, 10, 15, 20, 25, 50, 60, 65},
                    {15, 10, 20, 30, 20, 20, 20, 25, 50, 55, 60},
                    {15, 10, 0, 35, 10, 15, 20, 30, 65, 75, 85}
            };
