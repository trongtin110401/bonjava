...
public class Slot25ExtendItems {
    ...
    private static int[][] config = new int[][]
            {
                    {50, 50, 0, 35, 10, 10, 12, 25, 75, 80, 85},
                    {50, 50, 50, 25, 10, 15, 20, 25, 50, 60, 65},
                    {50, 50, 30, 35, 10, 15, 20, 25, 50, 60, 65},
                    {50, 50, 25, 30, 20, 20, 20, 25, 50, 55, 60},
                    {50, 50, 0, 35, 10, 15, 20, 30, 65, 75, 85}
            };


//    private static int[][] config = new int[][]
//            {
//                    {300, 10, 0, 35, 10, 10, 12, 25, 75, 30, 25},
//                    {300, 10, 50, 25, 10, 15, 20, 25, 50, 30, 25},
//                    {300, 10, 30, 35, 10, 15, 20, 25, 50, 30, 25},
//                    {300, 10, 25, 30, 20, 20, 20, 25, 50, 35, 20},
//                    {300, 10, 0, 35, 10, 15, 20, 30, 65, 35, 25}
//            };
