...
//            };
    ...
    private static final int[][] config = new int[][]
            {
                    {50, 50, 0, 80, 10, 10, 10, 12, 12, 25, 75, 75, 80, 80},
                    {50, 50, 30, 0, 10, 15, 10, 20, 12, 25, 50, 75, 60, 60},
                    {50, 50, 0, 80, 10, 15, 15, 20, 12, 25, 50, 75, 60, 60},
                    {50, 50, 30, 0, 20, 20, 20, 20, 12, 25, 50, 75, 55, 55},
                    {50, 50, 0, 80, 10, 15, 15, 20, 12, 30, 65, 75, 75, 75}
            };
