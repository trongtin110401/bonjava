...
//            };
    ...
    private static final int[][] config = new int[][]
            {
                    {40, 50, 0, 80, 10, 10, 10, 12, 12, 25, 35, 35, 30, 30},
                    {40, 50, 40, 0, 10, 15, 10, 20, 12, 25, 30, 35, 30, 30},
                    {40, 50, 0, 80, 10, 15, 15, 20, 12, 25, 30, 35, 30, 30},
                    {40, 50, 40, 0, 20, 20, 20, 20, 12, 25, 30, 35, 35, 35},
                    {40, 50, 0, 80, 10, 15, 15, 20, 12, 30, 35, 35, 35, 35}
            };
