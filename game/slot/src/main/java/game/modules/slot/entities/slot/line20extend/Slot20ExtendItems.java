...
//            };
    ...
    private static final int[][] config = new int[][]
            {
                    {10, 10, 0, 80, 10, 10, 10, 12, 12, 15, 15, 15, 10, 10},
                    {10, 10, 50, 0, 10, 15, 10, 20, 12, 15, 10, 15, 10, 10},
                    {10, 10, 0, 80, 10, 15, 15, 20, 12, 15, 10, 15, 10, 10},
                    {10, 10, 50, 0, 20, 20, 20, 20, 12, 15, 10, 15, 15, 15},
                    {10, 10, 0, 80, 10, 15, 15, 20, 12, 10, 15, 15, 15, 15}
            };
