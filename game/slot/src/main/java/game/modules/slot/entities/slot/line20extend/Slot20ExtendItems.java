...
public class Slot20ExtendItems {
    ...
    private static final int[][] config = new int[][]
            {
                    {8, 8, 0, 35, 10, 10, 10, 20, 20, 25, 75, 75, 80, 80, 0},
                    {8, 8, 40, 0, 10, 15, 15, 20, 20, 25, 50, 50, 60, 60, 0},
                    {8, 8, 0, 35, 10, 15, 15, 20, 20, 25, 50, 50, 60, 60, 0},
                    {8, 8, 0, 0, 20, 20, 20, 20, 20, 25, 50, 50, 55, 55, 40},
                    {8, 8, 0, 35, 10, 15, 15, 20, 20, 30, 65, 65, 75, 75, 0}
            };


//    private static final int[][] config = new int[][]
//            {
//                    {8, 8, 0, 35, 10, 10, 10, 12, 12, 25, 35, 40, 50, 55, 0},
//                    {8, 8, 15, 0, 10, 15, 10, 20, 12, 25, 30, 30, 50, 55, 0},
//                    {8, 8, 0, 35, 10, 15, 15, 20, 12, 25, 30, 40, 50, 55, 0},
//                    {8, 8, 0, 0, 20, 20, 20, 20, 12, 25, 30, 40, 50, 55, 15},
//                    {8, 8, 0, 35, 10, 15, 15, 20, 12, 30, 35, 40, 50, 55, 0}
//            };
